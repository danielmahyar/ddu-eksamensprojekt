...
const RatingsSection = ({ ratings }: { ratings: Array<{ name: string, review: string, photoURL: string, role: string }> }) => {
	return (
		<section className="w-full max-w-6xl mx-auto h-auto mb-10 px-4 space-y-16">
			<h1 className="font-thin mb-10 text-4xl text-center">Se hvad andre synes om AmfoLabs</h1>
